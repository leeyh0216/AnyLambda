...
object RuntimeScalaCompiler {
  ...
  class Builder() extends Logging {
    ...
    var resDir: String = _
    var classPathSegment = DEFAULT_CLASS_PATH_SEGMENT
    var jarPathSegment = DEFAULT_JAR_PATH_SEGMENT
    ...
    def setClassPathSegment(dir: String):Builder = { this.classPathSegment = classPathSegment; this }
    def setJarPathSegment(dir: String):Builder = { this.jarPathSegment = jarPathSegment; this }
    ...
    def build(): RuntimeScalaCompiler = {
      ...
      require(classPathSegment != null && classPathSegment.nonEmpty, "Class directory cannot be null or empty")
      val resultClassDir = new File(resPath, classPathSegment)
      ...
      require(jarPathSegment != null && jarPathSegment.nonEmpty, "Jar directory cannot be null or empty")
      val resultJarDir = new File(resPath, jarPathSegment)
...
class RuntimeScalaCompiler private (srcDir: String, dependenciesDirs: Option[List[String]],
  ...
  def compile(): CompileResult ={
    ...
    CompileResult(scalaFiles, dependencyLibs, compileEndTime - compileStartTime, jarFile.getAbsolutePath)
  }
